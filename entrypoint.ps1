...
Invoke-CIProfile -Name $Profile -Steps @{
    ...
    build = @{
        Steps = {
            ...
            Write-Information "Templating CertCheckStor.psd1"
            Format-TemplateFile -Template source/CertCheckStor.psd1.tpl -Target source/CertCheckStor/CertCheckStor.psd1 -Content @{
            ...
            Install-PSModuleFromManifest -ManifestPath source/CertCheckStor/CertCheckStor.psd1

            # Test the module manifest
            Write-Information "Testing module manifest"
            Test-ModuleManifest source/CertCheckStor/CertCheckStor.psd1

            # Import modules as test
            Write-Information "Importing module"
            Import-Module ./source/CertCheckStor/CertCheckStor.psm1
        }
    }
    ...
    release = @{
        Steps = "build", {
            ...
            Publish-Module -Path ./source/CertCheckStor -NuGetApiKey $Env:NUGET_API_KEY
        }
    }
}
